...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-10 16:41`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/459bad8c-d378-49b1-93fb-cac31b6ebf08.git
$ cd 459bad8c-d378-49b1-93fb-cac31b6ebf08
```
